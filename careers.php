...
<head>
  ...
  <title>Jac Olivol — Careers</title>
  ...
  <nav class="navbar-custom" id="mainNav">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <ul class="navbar-nav d-none d-lg-flex flex-row align-items-center">
        ...
        <li class="nav-item">
          <a class="nav-link nav-sep" style="padding-right:4px;" href="sustainability-and-impact">
            Sustainability & Impact
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link active-tab" href="careers">Careers</a>
        </li>
    ...
    <div
      ...
      <div class="mob-item">
        <a href="brands" class="mob-link">Our Brands</a>
      </div>

      <div class="mob-item">
        <a href="philosophy" class="mob-link">Our Philosophy</a>
      </div>

      <div class="mob-item">
        <a href="sustainability-and-impact" class="mob-link">
          Sustainability & Impact
        </a>
      </div>

      <div class="mob-item">
        <a href="careers" class="mob-link">Careers</a>
      </div>

      <div class="mob-item">
        <a href="contact" class="mob-link">Contact Us</a>
      </div>
