          ...
          <div class="bf-sticky">
            ...
            <div class="brand-directory-main" id="brandMain">
                ...
                <div class="bd-cat-block reveal" data-cat="skin-body-essential">
                    ...
                    <div class="bd-grid">
                        <a href="catalogue#jac-olivol" class="bd-tile"
                            data-search="jac olivol skin body care olive chemistry">
                        ...
                        <a href="javascript:void(0);" class="bd-tile"
                            ...
                            <div class="bd-tile-logo">
                                <!-- OliCerin -->
                                <img src="https://brandaid.digital/proposals/jac-olivol/new/html/images/OlicerinCircle.webp"
                                    alt="OliCerin"
                                    onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
                                <div class="bd-tile-icon" style="display:none;"><i class="fas fa-droplet"></i></div>
                            </div>
            ...
            <div class="bd-grid">
              ...
              <a href="catalogue.php?page=9" class="bd-tile" data-search="tortli baby care gentle first day">
                ...
                <div class="bd-cat-block reveal" data-cat="bath_essential">
                    ...
                    <div class="bd-grid">
                        <a href="catalogue#zestup" class="bd-tile"
                            data-search="hahnemann wellness everyday household">
                            <div class="bd-tile-logo">
                        ...
                        <a href="catalogue#hyper-lush" class="bd-tile"
                            data-search="hahnemann wellness everyday household">
                            <div class="bd-tile-logo">
                                <img src="https://brandaid.digital/proposals/jac-olivol/new/html/images/HyperlushCircle.webp"
                                    alt="Hyper Lush"
                                    onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
                                <div class="bd-tile-icon" style="display:none;"><i class="fas fa-capsules"></i></div>
                            </div>
                ...
                <div class="bd-cat-block reveal" data-cat="hygiene_protection">
                    ...
                    <div class="bd-grid">
                        <a href="catalogue#active-guard" class="bd-tile"
                            data-search="hahnemann wellness everyday household">
                            <div class="bd-tile-logo">
                ...
                <div class="bd-cat-block reveal" data-cat="men_rooming">
                    ...
                    <div class="bd-grid">
                        ...
                        <a href="javascript:void(0);" class="bd-tile"
                            data-search="kryo performance sports personal care">
                            <div class="bd-tile-logo">
                                <img src="https://brandaid.digital/proposals/jac-olivol/new/html/images/HammerCircle.webp"
                                    alt="Hammer"
                                    onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
