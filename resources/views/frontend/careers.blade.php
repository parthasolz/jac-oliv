  ...
  <section class="life-sec">
    ...
    <div class="container" style="position:relative;z-index:2;">
      ...
      <div class="life-mosaic">
        ...
        <img
            src="{{ asset('images/careers-g1.png') }}"
            alt="Team collaboration"
            onerror="this.src='{{ asset('images/careers-g1.png') }}'">
        ...
        <div class="life-tile reveal" data-d="1">
          ...
          <img
            src="{{ asset('images/careers-g5.png') }}"
            alt="R&D Lab"
            onerror="this.src='{{ asset('images/careers-g5.png') }}'">
        ...
        <div class="life-tile reveal" data-d="2">
          ...
          <img
            src="{{ asset('images/careers-g4.png') }}"
            alt="Team culture"
            onerror="this.src='{{ asset('images/careers-g4.png') }}'">
        ...
        <div class="life-tile reveal" data-d="1">
          ...
          <img
            src="{{ asset('images/careers-g3.png') }}"
            alt="Office life"
            onerror="this.src='{{ asset('images/careers-g3.png') }}'">
        ...
        <div class="life-tile reveal" data-d="2">
          ...
          <img
            src="{{ asset('images/careers-g2.png') }}"
            alt="Growth"
            onerror="this.src='{{ asset('images/careers-g2.png') }}'">
